...
class PostTable(models.Model):
    ...
    tag = models.CharField(
        max_length=20, default="post"
    )  # lost_found,suggestion,problems,trending,memes/jokes,fets/club/sport,events
...
class post_Likes(models.Model):
    post_id = models.ForeignKey(
        PostTable, on_delete=models.CASCADE, related_name="post_like_id"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class post_Comments(models.Model):
    post_id = models.ForeignKey(
        PostTable, on_delete=models.CASCADE, related_name="post_comment"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class LST_Comments(models.Model):
    lst_cmnt_id = models.ForeignKey(
        Lost_Found, on_delete=models.CASCADE, related_name="lst_found_comment"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class BS_Comments(models.Model):
    bs_cmnt_id = models.ForeignKey(
        Buy_Sell, on_delete=models.CASCADE, related_name="buy_sell_comment"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class Event_likes(models.Model):
    event_id = models.ForeignKey(
        Events, on_delete=models.CASCADE, related_name="event_like_id"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="event_like"
    )
    posted_date = models.DateTimeField(default=datetime.now)
    domain = models.TextField(default="@nitc.ac.in")
...
class ALERT_Comments(models.Model):
    alert_cmnt_id = models.ForeignKey(
        Alerts, on_delete=models.CASCADE, related_name="alert_comment"
    )
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
...
class BranchSubYears(models.Model):
    ...
    sub_name = models.ForeignKey(
        BranchSub, on_delete=models.CASCADE, related_name="CalenderSub"
    )
...
class BranchSubFiles(models.Model):
    ...
    year_id = models.ForeignKey(
        BranchSubYears, on_delete=models.CASCADE, related_name="CalenderSubYears"
    )
    description = models.TextField(default="@")
...
class Ratings(models.Model):
    username = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="Ratings_user"
    )
    sub_name = models.ForeignKey(
        BranchSub, on_delete=models.CASCADE, related_name="CalenderSub_ratings"
    )
    description = models.TextField(default="@")
...
class CalenderEvents(models.Model):
    ...
    title = models.CharField(max_length=100, default="")
    description = models.TextField(default="")
    calender_date_file = models.FileField(
        upload_to="pg", default="static/img.png"
    )  # cal_events
    file_type = models.CharField(default="@", max_length=100)
...
class Time_table(models.Model):
    ...
    branch_tb_img = models.ImageField(
        upload_to="pg", default="static/img.png"
    )  # time_table
    img_ratio = models.FloatField(default=1.00)
    domain = models.TextField(default="@nitc.ac.in")
